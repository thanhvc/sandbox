...
import org.exoplatform.social.sandbox.fsm.annotation.FSMConfiguration;
import org.exoplatform.social.sandbox.fsm.event.TransitionEventListener;
import org.exoplatform.social.sandbox.fsm.util.ConfigurationUtil;
...
public abstract class FSM<C, A> {
  ...
  private final Activity<C> startActivity;
  
  private Activity<C> currentActivity;
  ...
  public FSM(Activity<C> startActivity) {
  ...
  public Activity<C> getCurrentState() {
    return currentActivity;
  }

  public void setCurrentState(Activity<C> nextState) {
