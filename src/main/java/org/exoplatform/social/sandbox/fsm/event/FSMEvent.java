 ...
 */
package org.exoplatform.social.sandbox.fsm.event;
...
public class FSMEvent<C, A> {
  ...
  private final Activity<C> machineState;
  
  private final A machineStack;
  
  private final String name;
  
  public FSMEvent(String name, Activity<C> state, A stack) {
    this.name = name;
    this.machineState = state;
    this.machineStack = stack;
  }
  
  public FSMEvent(Activity<C> state, A stack) {
