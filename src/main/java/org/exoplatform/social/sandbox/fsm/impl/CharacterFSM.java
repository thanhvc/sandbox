 ...
 */
package org.exoplatform.social.sandbox.fsm.impl;

import java.io.IOException;
import java.io.Reader;

import org.exoplatform.social.sandbox.fsm.Activity;
import org.exoplatform.social.sandbox.fsm.FSM;
import org.exoplatform.social.sandbox.fsm.InputTape;
...
public abstract class CharacterFSM extends FSM<Character, Character> {
  ...
  public CharacterFSM(Activity<Character> startState) {
    super(startState);
  }
