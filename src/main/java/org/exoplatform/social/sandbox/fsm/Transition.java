...
public class Transition<C> {
  ...
  private final Activity<C> from;
  private final Activity<C> to;
  
  public Transition(final C letter, final Activity<C> from, final Activity<C> to) {
    this.letter = letter;
    this.from = from;
    this.to = to;
  }
  ...
  public Activity<C> getTo() {
    return this.to;
  }
  
  public Activity<C> getFrom() {
    return this.from;
  }
